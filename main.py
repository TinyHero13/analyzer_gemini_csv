...
if uploaded_file:
    ...
    if question:
        ...
        response = model.generate_content(f"""
                                        ...
                                        Quando o usuário inserir 'Calcule:', você deve fornecer um código em Python para realizar operações no DataFrame, utilizando 'df' seguido do código específico para realizar a operação desejada. Por exemplo, 'Quantidade de linhas: df.shape()', 'Primeiras linhas: df.head()', etc. 
